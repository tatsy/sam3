...
class TestLoadVideoFramesRouting(unittest.TestCase):
    ...
    def test_mp4_extension_routes_to_video_loader(self, mock_load_video: MagicMock) -> None:
    ...
    @patch('sam3.model.io_utils.load_video_frames_from_video_file')
    def test_mov_extension_routes_to_video_loader(self, mock_load_video: MagicMock) -> None:
    ...
    @patch('sam3.model.io_utils.load_video_frames_from_video_file')
    def test_extensionless_oil_path_routes_to_video_loader(self, mock_load_video: MagicMock) -> None:
    ...
    @patch('sam3.model.io_utils.load_video_frames_from_video_file')
    def test_extensionless_bare_hash_routes_to_video_loader(self, mock_load_video: MagicMock) -> None:
    ...
    @patch('sam3.model.io_utils.load_video_frames_from_video_file')
    def test_extensionless_path_raises_on_decode_failure(self, mock_load_video: MagicMock) -> None:
    ...
    def test_directory_routes_to_image_folder_loader(self, mock_load_folder: MagicMock) -> None:
    ...
    @patch('sam3.model.io_utils.load_video_frames_from_video_file')
    def test_unknown_extension_routes_to_video_loader(self, mock_load_video: MagicMock) -> None:
